    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 pt-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl text-blue-700 dark:text-blue-400 font-medium mb-4"
        >
          {profile.role}
        </motion.p>
        ...
        <motion.p
          ...
          className="max-w-lg mx-auto text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed"
        >
          {profile.tagline}
        </motion.p>
        ...
        >
          {profile.socials.map((s) => (
            <a
              ...
              className="w-10 h-10 flex items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-blue-900 hover:text-white dark:hover:bg-blue-600 transition-colors"
              aria-label={s.name}
            >
              {iconPaths[s.icon]}
            </a>
        ...
        >
          <a
            ...
            className="px-6 py-3 rounded-lg bg-blue-900 text-white font-medium hover:bg-blue-800 transition-colors"
          >
            View Projects
          </a>
          {profile.resumeUrl && (
